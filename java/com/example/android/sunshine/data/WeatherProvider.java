...
public class WeatherProvider extends ContentProvider {
    ...
    private static final String sWeather = WeatherContract.WeatherEntry.TABLE_NAME;
    ...
    static UriMatcher buildUriMatcher() {
        ...
        match.addURI(authority, WeatherContract.PATH_WEATHER, WEATHER);
        match.addURI(authority, WeatherContract.PATH_WEATHER +"/*", WEATHER_WITH_LOCATION);
        match.addURI(authority, WeatherContract.PATH_WEATHER +"/*/#", WEATHER_WITH_LOCATION_AND_DATE);
        match.addURI(authority, WeatherContract.PATH_LOCATION, LOCATION);
