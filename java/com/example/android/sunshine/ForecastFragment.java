      ...
      */
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            for (String s : resultStrs) {
                Log.v("hahahah", "Forecast entry: " + s);
            }
        ...
        protected String[] doInBackground(String... params) {
            ...
            Uri build = Uri.parse("http://api.openweathermap.org/data/2.5/forecast/daily?").buildUpon()
                    .appendQueryParameter("q", params[0])
                    .appendQueryParameter("mode", "json")
                    .appendQueryParameter("units", "metric")
                    .appendQueryParameter("cnt", "7")
                    .appendQueryParameter("appid", "4e27ac68cafacfaaa6e7a2f8db8fbeda")
                    .build();
            ...
            try {
                ...
                Log.v(LOG_TAG, "Forecast of JSON String : " + forecastJsonStr);
